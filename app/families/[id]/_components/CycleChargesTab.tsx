...
function CycleChargesTabContent(props: FamilyDetailContextValue) {
  const { formatMoney, data, loadMoreLedgerForTab, ledgerHasMore, loadingMoreLedgerTab } = props
        ...
        columns={[
          {
            ...
            cell: (c: any) => (
              <span className="tabular">{new Date(c.chargeDate).toLocaleDateString()}</span>
            ),
