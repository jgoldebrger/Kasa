    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-app">
      <div className="max-w-md text-center space-y-4">
        ...
        <p className="text-sm text-fg-muted">
          We couldn&apos;t reach the network. Recently viewed families, payments, and statements
          are cached — try going back, or reconnect and reload this page.
        </p>
        <button
          type="button"
          onClick={() => {
          ...
          className="focus-ring inline-flex items-center justify-center rounded-md bg-accent text-accent-fg px-4 py-2 text-sm font-medium hover:opacity-90"
        >
          Try again
        </button>
      </div>
