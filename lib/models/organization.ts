...
const OrganizationSchema = new Schema({
  ...
  barMitzvahAutoCreateEventTypeId: { type: Schema.Types.ObjectId, ref: 'LifecycleEvent', default: null },
  ...
  weddingConversionDefaultPlanId: { type: Schema.Types.ObjectId, ref: 'PaymentPlan', default: null },
